...
public class SiriusFont implements IFreeable
{
	 ...
	 */
	public SiriusFont(boolean antiAlias)
	{
	 ...
	 * @param antiAlias Wheter the font should be antialiased or not
	 */
	public SiriusFont(int size, boolean antiAlias)
	{
	 ...
	 */
	public SiriusFont(InputStream in, int size) throws FontFormatException, IOException
	{
		this(in, size, true);
	}
	 ...
	 * @throws IOException         If font can't be read
	 */
	public SiriusFont(InputStream in, int size, boolean antiAlias) throws FontFormatException, IOException
	{
	 ...
	 */
	public SiriusFont(java.awt.Font font)
	{
		this(font, true);
	}
	 ...
	 * @param antiAlias Wheter the font should be antialiased or not
	 */
	public SiriusFont(java.awt.Font font, boolean antiAlias)
	{
		glyphs = new HashMap<>();
